...
import { IndianController } from '../controllers/indian.controller';
import { Vehicle } from './vehicle';
import got from 'got';
import logger from '../logger';

export default class IndianVehicle extends Vehicle {
  ...
  constructor(public vehicleConfig: VehicleRegisterOptions, public controller: IndianController) {
    super(vehicleConfig, controller);
    logger.debug(`IN Vehicle ${this.vehicleConfig.id} created`);
  }
  ...
  public async start(config: VehicleStartOptions): Promise<string> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.start');
    }
  }
  ...
  public async stop(): Promise<string> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.stop');
    }
  }
  ...
  public async lock(): Promise<string> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.lock');
    }
  }
  ...
  public async unlock(): Promise<string> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.unlock');
    }
  }
  ...
  public async fullStatus(input: VehicleStatusOptions): Promise<FullVehicleStatus | null> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.fullStatus');
    }
  }
  ...
  public async status(
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.status');
    }
  }
  ...
  public async odometer(): Promise<VehicleOdometer | null> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.odometer');
    }
  }
  ...
  public async location(): Promise<VehicleLocation> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.location');
    }
  }
  ...
  public async startCharge(): Promise<string> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.startCharge');
    }
  }
  ...
  public async stopCharge(): Promise<string> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.stopCharge');
    }
  }
  ...
  public async monthlyReport(
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.monthyReports');
    }
  }
  ...
  public async tripInfo(
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.history');
    }
  }
  ...
  public async getChargeTargets(): Promise<DeepPartial<VehicleTargetSOC>[] | undefined> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.getChargeTargets');
    }
  }
  ...
  public async setChargeTargets(limits: { fast: ChargeTarget; slow: ChargeTarget }): Promise<void> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.setChargeTargets');
    }
  }
  ...
  public async setNavigation(poiInformations: EUPOIInformation[]): Promise<void> {
    ...
    try {
      ...
      throw manageBluelinkyError(err, 'IndianVehicle.setNavigation');
    }
  }
